...
public class ReviewController {
    ...
    public ResponseEntity<Void> uploadReview(@PathVariable Long storeId,
        ...
        return ResponseEntity.created(URI.create(String.format("/api/stores/%d/reviews/", storeId) + reviewId))
                .build();
    }
